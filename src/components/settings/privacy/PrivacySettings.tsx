    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <input
          ...
          checked={twoFactor}
          onChange={(e) =>
            useSettingsStore.setState({ twoFactor: e.target.checked })
          }
        />
      </div>
      ...
      <div>
        ...
        <div className="mt-3 flex gap-2">
          <button
            onClick={() => useSettingsStore.setState({ lastDevices: [] })}
          ...
          <button
            onClick={() => alert("TODO: implement logout from all devices")}
        ...
        <div className="mt-3 flex gap-2">
          ...
          <button
            onClick={() =>
              ...
              alert("TODO: delete account server-side")
            }
