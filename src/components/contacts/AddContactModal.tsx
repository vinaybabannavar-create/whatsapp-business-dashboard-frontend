    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-[var(--surface)] p-6 rounded-xl w-80 border border-[var(--border)] shadow">
        ...
        <div className="flex justify-end gap-2">
          <button className="px-4 py-2 rounded bg-gray-500 text-white" onClick={onClose}>
            Cancel
          </button>
          <button className="px-4 py-2 rounded bg-[var(--primary)] text-white" onClick={handleSave}>
            Save
          </button>
        </div>
      </div>
